...
.. note::
   ...
   sales order and, one new sale is mentioned in the upper right corner of the subscription.

   .. image:: media/renewals_3.png
     :align: center
     :alt: Renew a quotation with Odoo Subscriptions

   By clicking on the *Sales* button, you will have a summary of your sales orders in a list view.
   The only difference here between your two quotations is the description underneath the
